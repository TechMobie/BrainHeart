              ...
              children: [
                ...
                Expanded(
                  child: ListView.separated(
                    itemCount: _additionalInfoController.religionList.length,
                    shrinkWrap: true,
                        ...
                        () => GestureDetector(
                          ...
                          onTap: () {
                            _additionalInfoController
                                .religionCurrentIndex.value = index;
                          },
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text(
                                _additionalInfoController.religionList[index],

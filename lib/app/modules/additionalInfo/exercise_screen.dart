        ...
        children: [
          Positioned.fill(
            child: Column(
              ...
              children: [
                ...
                ListView.separated(
                  itemCount: _additionalInfoController.exerciseList.length,
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, index) {
                    return Obx(
                      () => GestureDetector(
                        ...
                        onTap: () {
                          _additionalInfoController.exerciseCurrentIndex.value =
                              index;
                        },
                        child: Row(
                          ...
                          children: [
                            Text(
                              _additionalInfoController.exerciseList[index],
          ...
          Align(
            ...
            child: SaveButton(
              title: "Next",
              onTap: () {
                Get.toNamed(Routes.alcoholScreen);
              },
